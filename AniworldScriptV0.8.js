...
(async function () {
  ...
  const SKIP_CONFIG = {
    ...
    get skipX() {
      return advancedSettings[ADVANCED_SETTINGS_MAP.skipX];
    },
    get skipC() {
      return advancedSettings[ADVANCED_SETTINGS_MAP.skipC];
    },
    get skipV() {
      return advancedSettings[ADVANCED_SETTINGS_MAP.skipV];
    },
    get skipB() {
      return advancedSettings[ADVANCED_SETTINGS_MAP.skipB];
    },
  };
  // ============================================
  ...
  const localizations = {
    en: {
      firstRunInfoText: () =>
        `Right-click the button for settings. In fullscreen, scroll to switch providers.`,
      loading: "Loading",
      ...
      reportBug:
        ". The value would reset upon player reload. Please, report the bug, with a mention of a URL of the page you're currently on",
      autoplayError:
        "The script got an error trying autoplay. Try again, and if the problem persists, report the bug, or you can try switching video player providers if possible",
      lastAutoplayError:
        "Last autoplay end up with an error, but you should be at the next episode page now. Try again, and if the problem persists, report the bug, or you can try switching video player providers if possible",
      preferences: "Preferences",
      advanced: "Advanced",
      apply: "Apply",
      miscellaneous: "Miscellaneous",
      persistentMutedAutoplay: "Persistent muted autoplay",
      persistentMutedAutoplayTooltip:
      ...
      highlightVisitedEpisodesTooltip:
        "Highlights previously visited episode links in yellow so you can easily see which episodes you have already opened",
      ...
      prevEpisodeTooltip:
        "Hotkey to go to the previous episode. Page reload is required for this setting to take effect!",
      nextEpisode: "Next episode*",
      nextEpisodeTooltip:
        "Hotkey to go to the next episode. Page reload is required for this setting to take effect!",
      cancelAutoplay: "Cancel autoplay*",
      cancelAutoplayTooltip:
        "Hotkey to cancel the autoplay countdown. Page reload required.",
      visitedEpisodeColor: "Visited episode color",
      visitedEpisodeColorTooltip:
        "Color used to highlight visited episode links",
    },
    de: {
      firstRunInfoText: () =>
        `Rechtsklick auf den Button für Einstellungen. Im Vollbild scrollen, um Anbieter zu wechseln.`,
      ...
      reportBug:
        ". Der Wert wird beim Neuladen des Players zurückgesetzt. Bitte melden Sie den Fehler unter Angabe der URL der aktuellen Seite",
      autoplayError:
        "Das Skript hat beim Versuch des Autoplays einen Fehler erhalten. Versuchen Sie es erneut. Wenn das Problem weiterhin besteht, melden Sie den Fehler oder versuchen Sie, den Video-Player-Anbieter zu wechseln, falls möglich",
      lastAutoplayError:
        "Das letzte Autoplay ist mit einem Fehler beendet, aber Sie sollten jetzt auf der Seite der nächsten Episode sein. Versuchen Sie es erneut. Wenn das Problem weiterhin besteht, melden Sie den Fehler oder versuchen Sie, den Video-Player-Anbieter zu wechseln, falls möglich",
      ...
      autoSkipAtStartTooltip:
        "Überspringt automatisch den Anfang eines Videos, wenn es startet. Aktivieren Sie dies, um die Überspringfunktion zu aktivieren.",
      skipSecondsOnStart: "Sekunden am Anfang überspringen",
      skipSecondsOnStartTooltip:
        "Anzahl der Sekunden, die vom Anfang an übersprungen werden sollen, wenn das automatische Überspringen aktiviert ist.",
      introSkipSize: "Intro-Skipgröße, Sek",
      introSkipSizeTooltip:
        "Intro-Skipgröße. Dies ist mit dem Titel verknüpft und sollte über alle Episoden hinweg gleich bleiben",
      outroSkipThreshold: "Outro-Skipschwelle, Sek",
      outroSkipThresholdTooltip:
        "Autoplay wird ausgelöst, wenn der Videoplayer weniger als DIESE Anzahl von Sekunden zum Abspielen übrig hat. Es ist mit dem Titel verknüpft und sollte über alle Episoden hinweg gleich bleiben",
      resetToDefaults: "Auf Standard zurücksetzen",
      hotkeys: "Hotkeys",
      fastBackward: "Schneller Rücklauf*",
      fastBackwardTooltip:
        "Hotkey für einen schnellen Rücklauf. Ein Neuladen der Seite ist für diese Einstellung erforderlich!",
      fastForward: "Schneller Vorlauf*",
      fastForwardTooltip:
        "Hotkey für einen schnellen Vorlauf. Ein Neuladen der Seite ist für diese Einstellung erforderlich!",
      fullscreen: "Vollbild*",
      fullscreenTooltip:
        "Hotkey zum Umschalten des Vollbildmodus. Ein Neuladen der Seite ist für diese Einstellung erforderlich!",
      largeSkip: "Intro überspringen*",
      largeSkipTooltip:
        "Hotkey für einen Intro-Skip. Ein Neuladen der Seite ist für diese Einstellung erforderlich!",
      ...
      fastForwardSizeTooltip:
        "Anzahl der Sekunden, die mit Doppeltipps oder durch Drücken einer entsprechenden Hotkey übersprungen oder zurückgespult werden sollen",
      highlightVisitedEpisodes: "Besuchte Episoden hervorheben",
      highlightVisitedEpisodesTooltip:
        "Hebt zuvor besuchte Episodenlinks gelb hervor, damit Sie leicht erkennen können, welche Episoden Sie bereits geöffnet haben",
      playOnIntroSkip: "Bei Intro-Skip abspielen",
      playOnIntroSkipTooltip: "Intro-Skip startet auch die Wiedergabe",
      corsProxy: "CORS-Proxy",
      corsProxyTooltip:
        "Um ein mögliches VOE-zu-VOE ungestummtes Autoplay zu ermöglichen, muss das Skript eine sehr kleine Anzahl von Webanfragen über einen eigenen Proxyserver leiten. Lassen Sie das Eingabefeld leer, um dies zu deaktivieren oder Ihren eigenen Proxy festzulegen",
      commlinkPollingInterval: "Commlink-Abfrageintervall, ms*",
      commlinkPollingIntervalTooltip:
        "Spiegelt die Reaktionsfähigkeit der Nachrichtenübertragung zwischen einem Player und einem Top-Scope wider. Kann die CPU-Auslastung beeinträchtigen, wenn sie zu niedrig eingestellt ist. 40 sollten ausreichen. Ein Neuladen der Seite ist für diese Einstellung erforderlich!",
      ...
      prevEpisodeTooltip:
        "Hotkey für die vorherige Episode. Ein Neuladen der Seite ist für diese Einstellung erforderlich!",
      nextEpisode: "Nächste Episode*",
      nextEpisodeTooltip:
        "Hotkey für die nächste Episode. Ein Neuladen der Seite ist für diese Einstellung erforderlich!",
      cancelAutoplay: "Autoplay abbrechen*",
      cancelAutoplayTooltip:
        "Hotkey zum Abbrechen des Autoplay-Countdowns. Seitenneuladen erforderlich.",
  ...
  const STO_DOMAINS = ["s.to", "serienstream.to", "186.2.175.5"];

  // Helper to detect if we're on the new S.to layout
  const isNewStoLayout = () => {
    return (
      STO_DOMAINS.includes(location.hostname) &&
  ...
  const ADVANCED_SETTINGS_DEFAULTS = {
    ...
    [ADVANCED_SETTINGS_MAP.corsProxy]:
      "https://aniworld-to-cors-proxy.fly.dev/",
  ...
  const hotkeysSettings = new DataStore(
    "hotkeysSettings",
    HOTKEYS_SETTINGS_DEFAULTS,
  );
  ...
  const getWatchProgress = () => {
    try {
      return JSON.parse(GM_getValue("watchProgress") || "{}");
    } catch {
      return {};
    }
  };
  ...
  const applySeasonProgress = (seasonLink, seasonId) => {
    ...
    const episodeLinks = [
      ...document.querySelectorAll(`a[data-season-id="${seasonId}"]`),
    ];
  ...
  const applyAllSeasonProgress = () => {
    if (!mainSettings[MAIN_SETTINGS_MAP.highlightVisitedEpisodes]) return;
    const currentSeasonLink = document.querySelector(
      "div#stream > ul:first-child a.active",
    );
    if (!currentSeasonLink) return;
    const seasonId =
      document.querySelector("a[data-season-id]")?.dataset.seasonId;
    if (!seasonId) return;
  ...
  function detectHold(
    element,
    callback,
    { holdTimeMs = 700, validPointerTypes = ["mouse", "pen", "touch"] } = {
      holdTimeMs: 700,
  ...
  class CommLinkHandler {
    constructor(commlinkID, configObj) {
      ...
      this.singlePacketResponseWaitTime =
        configObj?.singlePacketResponseWaitTime || 1500;
    ...
    send(platform, cmd, d) {
      return new Promise(async (resolve) => {
        ...
        for (;;) {
          ...
          if (!this.silentMode) {
            console.log(
              `[CommLink Sender] Sending packet! (#${attempts} attempt):`,
              packet,
            );
          }
          ...
          for (;;) {
            ...
            if (poolPacket && packetResult) {
              if (!this.silentMode) {
                console.log(
                  `[CommLink Sender] Got result for a packet (${packetID}):`,
                  packetResult,
                );
              }
            ...
            if (
              !poolPacket ||
              Date.now() - attemptStartDate > packetWaitTimeMs
            ) {
              break;
            }

            await new Promise((res) =>
              setTimeout(res, this.statusCheckInterval),
            );
          }
    ...
    registerSendCommand(name, obj) {
      this.commands[name] = async (data) => {
        return await this.send(
          obj?.commlinkID || this.commlinkID,
          name,
          obj?.data || data,
        );
      };
    ...
    registerListener(sender, commandHandler) {
      const listener = {
        sender,
        commandHandler,
        intervalObj: this.setIntervalAsync(
          this.receivePackets.bind(this),
    ...
    receivePackets() {
      this.getStoredPackets().forEach((packet) => {
        this.listeners.forEach((listener) => {
          if (
            packet.sender === listener.sender &&
            !packet.hasOwnProperty("result")
          ) {
            ...
            if (!this.silentMode) {
              if (packet.result === null) {
                console.log(
                  "[CommLink Receiver] Possibly failed to handle packet:",
                  packet,
                );
              } else {
                console.log(
                  "[CommLink Receiver] Successfully handled a packet:",
                  packet,
                );
              }
            }
  ...
  class IframeMessenger {
    ...
    async initCrossFrameConnection() {
      ...
      const topScopeIdPromise = new Promise((resolve) => {
        ...
        const valueChangeListenerId = GM_addValueChangeListener(
          iframeId,
      ...
      this.commLink.registerSendCommand(
        IframeMessenger.messages.REQUEST_CURRENT_FRANCHISE_DATA,
      );
      this.commLink.registerSendCommand(
        IframeMessenger.messages.OPEN_HOTKEYS_GUIDE,
      );
      this.commLink.registerSendCommand(
        IframeMessenger.messages.TOP_NOTIFLIX_REPORT_INFO,
      );
      this.commLink.registerSendCommand(
        IframeMessenger.messages.UPDATE_CORE_SETTINGS,
      );
      this.commLink.registerSendCommand(
        IframeMessenger.messages.UPDATE_EPISODE_PROGRESS,
      );
    }
  ...
  class IframeInterface {
    ...
    async init(player) {
      this.messenger.registerConnectionListener(
        this.handleTopScopeMessages.bind(this),
      );
    ...
    createAutoplayButton() {
      ...
      const isAutoplayEnabled =
        coreSettings[CORE_SETTINGS_MAP.isAutoplayEnabled];
      let lastClickTime = 0;
      button.addEventListener("click", () => {
        ...
        if (!GM_getValue("firstRunTextWasShown")) {
          ...
          this.messenger.sendMessage(
            IframeMessenger.messages.TOP_NOTIFLIX_REPORT_INFO,
            {
              args: [i18n.firstRunInfoText(), { timeout: 7000 }],
            },
          );
        }
        ...
        button.title = wasEnabled
          ? i18n.autoplayDisabled
          : i18n.autoplayEnabled;
        button.style.background = "";
        toggleContainer.style.backgroundColor = wasEnabled
          ? "rgba(221, 221, 221, 0.5)"
          : "#3eb489";
        toggleDot.style.backgroundColor = "#fff";
        toggleDot.style.transform = wasEnabled
          ? "translateX(0px)"
          : "translateX(12px)";
      });

      button.type = "button";
      button.title = !isAutoplayEnabled
        ? i18n.autoplayDisabled
        : i18n.autoplayEnabled;
      button.style.background = "";
      ...
      toggleContainer.style.backgroundColor = isAutoplayEnabled
        ? "#3eb489"
        : "rgba(221, 221, 221, 0.5)";
      ...
      toggleDot.style.backgroundColor = "#fff";
      toggleDot.style.transform = !isAutoplayEnabled
        ? "translateX(0px)"
        : "translateX(12px)";
      GM_addStyle(
        [
    ...
    createSettingsPane() {
      ...
      panel.querySelectorAll(".aw-tab").forEach((tab) => {
        tab.addEventListener("click", () => {
          panel
            .querySelectorAll(".aw-tab")
            .forEach((t) => t.classList.remove("active"));
          panel
            .querySelectorAll(".aw-tab-content")
            .forEach((c) => c.classList.remove("active"));
          tab.classList.add("active");
          panel
            .querySelector(`#aw-tab-${tab.dataset.tab}`)
      ...
      playbackCard.appendChild(
        createSettingRow(
          i18n.persistentMutedAutoplay,
          i18n.persistentMutedAutoplayTooltip,
          createToggle(
            "shouldAutoplayMuted",
            mainSettings[MAIN_SETTINGS_MAP.shouldAutoplayMuted],
            (v) => {
      ...
      const { section: appearanceSection, card: appearanceCard } =
        createSection("paint-brush", "Appearance", "appearance");

      // Build theme options from all available themes
      const allThemesOptions = Object.entries(getAllThemes()).map(
        ([id, theme]) => ({
          value: id,
      ...
      defaultsCard.appendChild(
        createSettingRow(
          ...
          createNumberInput(
            "fastForwardSizeS",
            advancedSettings[ADVANCED_SETTINGS_MAP.fastForwardSizeS],
            0,
            60,
            1,
            (v) => {
      ...
      // Hotkeys Section
      const { section: hotkeysSection, card: hotkeysCard } = createSection(
        "keyboard",
        i18n.hotkeys,
        "hotkeys",
      );
      hotkeysCard.appendChild(
        createSettingRow(
          i18n.fastBackward,
          i18n.fastBackwardTooltip,
          createTextInput(
            "fastBackward",
            hotkeysSettings[HOTKEYS_SETTINGS_MAP.fastBackward],
            (v) => {
              hotkeysSettings[HOTKEYS_SETTINGS_MAP.fastBackward] =
                v.toLowerCase();
            },
      ...
      hotkeysCard.appendChild(
        createSettingRow(
          ...
          createTextInput(
            "fastForward",
            hotkeysSettings[HOTKEYS_SETTINGS_MAP.fastForward],
            (v) => {
              hotkeysSettings[HOTKEYS_SETTINGS_MAP.fastForward] =
                v.toLowerCase();
            },
      ...
      hotkeysCard.appendChild(
        createSettingRow(
          ...
          createTextInput(
            "largeSkip",
            hotkeysSettings[HOTKEYS_SETTINGS_MAP.largeSkip],
            (v) => {
      ...
      hotkeysCard.appendChild(
        createSettingRow(
          ...
          createTextInput(
            "prevEpisode",
            hotkeysSettings[HOTKEYS_SETTINGS_MAP.prevEpisode],
            (v) => {
              hotkeysSettings[HOTKEYS_SETTINGS_MAP.prevEpisode] =
                v.toLowerCase();
            },
      ...
      hotkeysCard.appendChild(
        createSettingRow(
          ...
          createTextInput(
            "nextEpisode",
            hotkeysSettings[HOTKEYS_SETTINGS_MAP.nextEpisode],
            (v) => {
              hotkeysSettings[HOTKEYS_SETTINGS_MAP.nextEpisode] =
                v.toLowerCase();
            },
      ...
      hotkeysCard.appendChild(
        createSettingRow(
          ...
          createTextInput(
            "cancelAutoplay",
            hotkeysSettings[HOTKEYS_SETTINGS_MAP.cancelAutoplay],
            (v) => {
              hotkeysSettings[HOTKEYS_SETTINGS_MAP.cancelAutoplay] =
                v.toLowerCase();
            },
      ...
      const { section: skipDurationsSection, card: skipDurationsCard } =
        createSection(
          "fast-forward",
      ...
      skipDurationsNote.style.cssText =
        "padding: 4px 10px 4px 10px; color: mediumpurple;";
      skipDurationsNote.textContent = "Hold Alt to skip backwards.";
      skipDurationsCard.appendChild(skipDurationsNote);
      skipDurationsCard.appendChild(
        createSettingRow(
          "X key, sec",
          "Seconds skipped by the X key",
          createNumberInput(
            "skipX",
            advancedSettings[ADVANCED_SETTINGS_MAP.skipX],
            1,
            600,
            1,
            (v) => {
      ...
      skipDurationsCard.appendChild(
        createSettingRow(
          ...
          createNumberInput(
            "skipC",
            advancedSettings[ADVANCED_SETTINGS_MAP.skipC],
            1,
            600,
            1,
            (v) => {
      ...
      skipDurationsCard.appendChild(
        createSettingRow(
          ...
          createNumberInput(
            "skipV",
            advancedSettings[ADVANCED_SETTINGS_MAP.skipV],
            1,
            600,
            1,
            (v) => {
      ...
      skipDurationsCard.appendChild(
        createSettingRow(
          ...
          createNumberInput(
            "skipB",
            advancedSettings[ADVANCED_SETTINGS_MAP.skipB],
            1,
            600,
            1,
            (v) => {
      ...
      behaviorCard.appendChild(
        createSettingRow(
          ...
          createToggle(
            "highlightVisitedEpisodes",
            mainSettings[MAIN_SETTINGS_MAP.highlightVisitedEpisodes],
            (v) => {
      ...
      (() => {
        ...
        colorInput.style.cssText =
          "width:36px;height:28px;border-radius:4px;border:1px solid var(--border-color);background:var(--bg-tertiary);cursor:pointer;padding:2px;";
      ...
      behaviorCard.appendChild(
        createSettingRow(
          ...
          createToggle(
            "playOnLargeSkip",
            advancedSettings[ADVANCED_SETTINGS_MAP.playOnLargeSkip],
            (v) => {
      ...
      resetBtn.innerHTML =
        '<i class="fas fa-undo"></i> ' + i18n.resetToDefaults;
      resetBtn.addEventListener("click", () => {
        ...
        panel.querySelectorAll('input[type="checkbox"]').forEach((input) => {
          const key = input.id;
          if (ADVANCED_SETTINGS_MAP[key])
            input.checked = ADVANCED_SETTINGS_DEFAULTS[key];
          if (MAIN_SETTINGS_MAP[key])
            input.checked = MAIN_SETTINGS_DEFAULTS[key];
          if (CORE_SETTINGS_MAP[key])
            input.checked = CORE_SETTINGS_DEFAULTS[key];
        });
        panel.querySelectorAll('input[type="number"]').forEach((input) => {
          const key = input.id;
          if (ADVANCED_SETTINGS_DEFAULTS[key] !== undefined)
            input.value = ADVANCED_SETTINGS_DEFAULTS[key];
          if (CORE_SETTINGS_DEFAULTS[key] !== undefined)
            input.value = CORE_SETTINGS_DEFAULTS[key];
        });
        panel.querySelectorAll('input[type="text"]').forEach((input) => {
          const key = input.id;
          if (HOTKEYS_SETTINGS_DEFAULTS[key])
            input.value = HOTKEYS_SETTINGS_DEFAULTS[key];
          if (ADVANCED_SETTINGS_DEFAULTS[key] !== undefined)
            input.value = ADVANCED_SETTINGS_DEFAULTS[key];
        });
        showSaveIndicator();
      ...
      const paneInterface = {
        ...
        refresh: () => {
          ...
          panel.querySelectorAll('input[type="checkbox"]').forEach((input) => {
            const key = input.id;
            if (coreSettings[key] !== undefined)
              input.checked = coreSettings[key];
            if (mainSettings[key] !== undefined)
              input.checked = mainSettings[key];
            if (advancedSettings[key] !== undefined)
              input.checked = advancedSettings[key];
          });
          panel.querySelectorAll('input[type="number"]').forEach((input) => {
            const key = input.id;
            if (coreSettings[key] !== undefined)
              input.value = coreSettings[key];
            if (advancedSettings[key] !== undefined)
              input.value = advancedSettings[key];
          });
          panel.querySelectorAll('input[type="text"]').forEach((input) => {
            const key = input.id;
            if (hotkeysSettings[key] !== undefined)
              input.value = hotkeysSettings[key];
            if (advancedSettings[key] !== undefined)
              input.value = advancedSettings[key];
          });
        },
    ...
    setupHotkeys(player) {
      ...
      const cancelAutoplayKey =
        hotkeysSettings[HOTKEYS_SETTINGS_MAP.cancelAutoplay] || "backspace";
      ...
      keyboardJS.bind("x", () => {
        ...
        showSkipToast(SKIP_CONFIG.skipX);
      });
      keyboardJS.bind("c", () => {
        player.currentTime += SKIP_CONFIG.skipC;
        showSkipToast(SKIP_CONFIG.skipC);
      });
      keyboardJS.bind("v", () => {
        player.currentTime += SKIP_CONFIG.skipV;
        showSkipToast(SKIP_CONFIG.skipV);
      });
      keyboardJS.bind("b", () => {
        player.currentTime += SKIP_CONFIG.skipB;
        showSkipToast(SKIP_CONFIG.skipB);
      });
      keyboardJS.bind("alt + x", () => {
        player.currentTime -= SKIP_CONFIG.skipX;
        showSkipToast(SKIP_CONFIG.skipX, true);
      });
      keyboardJS.bind("alt + c", () => {
        player.currentTime -= SKIP_CONFIG.skipC;
        showSkipToast(SKIP_CONFIG.skipC, true);
      });
      keyboardJS.bind("alt + v", () => {
        player.currentTime -= SKIP_CONFIG.skipV;
        showSkipToast(SKIP_CONFIG.skipV, true);
      });
        ...
        if (
          ...
          const ticker = setInterval(() => {
            ...
            if (secondsLeft <= 0) {
              ...
              if (!cancelled) {
                this.messenger.sendMessage(
                  IframeMessenger.messages.AUTOPLAY_NEXT,
                );
              }
            } else {
              countdownEl.textContent = `⏭ Next episode in ${secondsLeft}...`;
  ...
  class VOEJWPIframeInterface extends IframeInterface {
    constructor(messenger) {
      super(messenger);
      waitForElement(
        ["div.guestMode", 'iframe[style*="z-index: 2147483647"]'].join(", "),
        {
          existing: true,
        },
        (ads) => ads.remove(),
    ...
    async preparePlayer(player) {
      ...
      waitForElement(
        VOEJWPIframeInterface.queries.fullscreenBtn,
        {
          existing: true,
          onceOnly: true,
        },
        (fsBtn) => {
          ...
          prevEpBtn.style.cssText =
            "width:44px;height:44px;padding:0;border-radius:50%;border:none;background:none !important;cursor:pointer;flex:0 0 auto;outline:none;";
          const prevEpIcon = document.createElement("span");
          prevEpIcon.textContent = "⏮";
          prevEpIcon.style.cssText =
            "font-size:16px;color:#fff;transition:opacity 0.2s ease;display:inline-block;";
          prevEpBtn.appendChild(prevEpIcon);
          prevEpBtn.addEventListener("mouseenter", () => {
            prevEpIcon.style.opacity = "0.65";
          });
          prevEpBtn.addEventListener("mouseleave", () => {
            prevEpIcon.style.opacity = "1";
          });
          ...
          nextEpIcon.style.cssText =
            "font-size:16px;color:#fff;transition:opacity 0.2s ease;display:inline-block;";
          nextEpBtn.appendChild(nextEpIcon);
          nextEpBtn.addEventListener("mouseenter", () => {
            nextEpIcon.style.opacity = "0.65";
          });
          nextEpBtn.addEventListener("mouseleave", () => {
            nextEpIcon.style.opacity = "1";
          });
  ...
  class TopScopeInterface {
          ...
          switch (packet.command) {
            ...
            case IframeMessenger.messages.REQUEST_CURRENT_FRANCHISE_DATA: {
              ...
              if (newStoLayout) {
                ...
                title =
                  document.querySelector("div.series-title > h1")?.innerText ||
                  null;

                // Extract slug, season, and episode number for AniSkip
                slug =
                  location.pathname.match(/^\/anime\/stream\/([^/]+)/)?.[1] ||
                  null;
                episodeNumber =
                  location.pathname.match(/\/episode-(\d+)\b/i)?.[1] || null;
                seasonNumber =
                  location.pathname.match(/\/staffel-(\d+)\b/i)?.[1] || null;
              }

              const currentFranchiseId = title
            ...
            case IframeMessenger.messages.UPDATE_EPISODE_PROGRESS: {
              ...
              data[episodeId] =
                progress >= WATCH_PROGRESS_THRESHOLD ? 1.0 : progress;
    ...
    async initCrossFrameConnection() {
      ...
      const iframeId = (this.currentIframeId = await new Promise(
        (resolve, reject) => {
          const valueChangeListenerId = GM_addValueChangeListener(
            "unboundIframeId",
            (_key, _oldValue, newValue) => {
              const iframe = document.querySelector(
                TopScopeInterface.queries.playerIframe,
              );
      ...
      this.commLink.registerListener(
        iframeId,
    ...
    async goToNextVideo() {
      ...
      if (newStoLayout) {
        ...
        const nextLinks = [
          ...document.querySelectorAll('a.btn-link[href*="episode"]'),
        ];
        ...
        if (nextLink) {
          ...
          const seasonPills = [
            ...document.querySelectorAll("[data-season-pill]"),
          ];
          const currentSeasonPill = seasonPills.find((el) =>
          ...
          if (currentIndex >= 0 && currentIndex < seasonPills.length - 1) {
            ...
            const nextSeasonDom = new DOMParser().parseFromString(
              nextSeasonHtml,
              "text/html",
            );
        ...
        // Old aniworld.to / legacy S.to layout
        const [seasonsNav, episodesNav] = document.querySelectorAll(
          `${Q.navLinksContainer} > ul`,
        );
        const episodesNavLinks = [...episodesNav.querySelectorAll("a")];
        const seasonNavLinks = [...seasonsNav.querySelectorAll("a")];
        const currentEpisodeIndex = episodesNavLinks.findIndex((el) =>
          el.classList.contains("active"),
        );
        const currentSeasonIndex = seasonNavLinks.findIndex((el) =>
          el.classList.contains("active"),
        );
        ...
        if (currentEpisodeIndex < episodesNavLinks.length - 1) {
          ...
          if (seasonNavLinks[currentSeasonIndex].href.endsWith("/filme"))
            return;
      ...
      const nextEpisodeDom = new DOMParser().parseFromString(
        nextEpisodeHtml,
        "text/html",
      );
      ...
      try {
        if (newStoLayout) {
          ...
          const allNewStoButtons = [
            ...document.querySelectorAll("#episode-links .link-box"),
          ];
          ...
          console.log(
            "[Autoplay] Successfully changed iframe src to:",
            nextVideoHref,
          );
        } else {
          ...
          (function repairWebsiteFeatures() {
            document.querySelectorAll(Q.providerChangeBtn).forEach((btn) => {
              btn.addEventListener("click", (ev) => {
                ...
                const hosterTarget =
                  parent.getAttribute("data-external-embed") === "true";
                const fakePlayer = document.querySelector(".fakePlayer");
                const inSiteWebStream =
                  document.querySelector(".inSiteWebStream");
          ...
          const allOldProviderButtons = [
            ...document.querySelectorAll(
              TopScopeInterface.queries.providerChangeBtn,
            ),
          ];
          ...
          if (nextVideoHref) {
            const providerNameEl = nextVideoLink.querySelector(
            ...
            if (providerNameEl?.innerText === VIDEO_PROVIDERS_MAP.VOE) {
              const corsProxy =
                advancedSettings[ADVANCED_SETTINGS_MAP.corsProxy];
              if (corsProxy) {
                const redirectText = await (
                  await fetch(corsProxy + nextVideoLink.href)
                ).text();
                const match = /location\.href = '(https:\/\/.+)';/.exec(
                  redirectText,
                );
    ...
    async goToPreviousVideo() {
      ...
      if (newStoLayout) {
        ...
        const prevLink = prevLinks.find((link) =>
          link.textContent.includes("←"),
        );
        ...
        if (prevLink) {
          ...
          if (currentIndex > 0) {
            ...
            const prevSeasonDom = new DOMParser().parseFromString(
              prevSeasonHtml,
              "text/html",
            );
            const episodeLinks = [
              ...prevSeasonDom.querySelectorAll("#episode-nav .nav-link"),
            ];
        ...
        if (currentEpisodeIndex > 0) {
          ...
          const prevEpisodeLinks = [
            ...prevSeasonDom.querySelectorAll(
              `${Q.navLinksContainer} > ul a[data-episode-id]`,
            ),
          ];
      ...
      const prevEpisodeDom = new DOMParser().parseFromString(
        prevEpisodeHtml,
        "text/html",
      );
      ...
      try {
        if (newStoLayout) {
          ...
          if (prevVideoHref) {
            const providerNameEl = prevVideoLink.querySelector(
              TopScopeInterface.queries.providerName,
            );
            if (providerNameEl?.innerText === VIDEO_PROVIDERS_MAP.VOE) {
              const corsProxy =
              ...
              if (corsProxy) {
                const redirectText = await (
                  await fetch(corsProxy + prevVideoLink.href)
                ).text();
                const match = /location\.href = '(https:\/\/.+)';/.exec(
                  redirectText,
                );
    ...
    `;
      ...
      modal
        .querySelector("#aw-watched-modal-close")
        .addEventListener("click", closeModal);
      overlay.addEventListener("click", closeModal);

      // Reset button with Notiflix confirm
      modal
        .querySelector("#aw-reset-season-btn")
        .addEventListener("click", () => {
          Notiflix.Confirm.show(
            ...
            () => {
              const episodeLinks = [
                ...document.querySelectorAll("a[data-episode-id]"),
              ];
              const data = getWatchProgress();
      ...
      const seasonLinks = [
        ...document.querySelectorAll(
          'div#stream > ul:first-child a[href*="/staffel-"], div#stream > ul:first-child a[href*="/filme"]',
        ),
      ];
      ...
      const episodesLabel = [
        ...document.querySelectorAll("div#stream ul li span"),
  ...
  if (!isEmbedded()) {
    ...
    try {
      ...
      if (
        lastAutoplayError &&
        Date.now() - lastAutoplayError.date <= 60 * 1000
      ) {
    ...
    if (newStoLayout) {
      ...
      await new Promise((resolve) => {
        waitForElement(
          TopScopeInterface.queries.selectedLanguageBtn,
          {
            existing: true,
            onceOnly: true,
            callbackOnTimeout: true,
  ...
  // If context is iframe scope
    ...
    const isItVOEJWP = !!document.querySelector(
    ...
    window.addEventListener(
      ...
      async () => {
        ...
        waitForElement(
          VOEJWPIframeInterface.queries.player,
          {
            existing: true,
            onceOnly: true,
          },
